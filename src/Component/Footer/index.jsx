                    ...
                    <Row className={'mx-3'}>
                        ...
                        <h5 className={' text-uppercase titlefooter'}>Nous contacter </h5>
                            <ul className="nav flex-column">
                                <li className="nav-item mb-2 text-white"><a href={"info@eb-company.com"} className="nav-link p-0 text-white all_link">info@eb-company.com</a></li>
                                <li className="nav-item mb-2 text-white"><Link to={"/"} className="nav-link p-0 text-white all_link">79 34 38 13 / 72 41 59 86 </Link></li>
                            </ul>
                        </Col>
                    </Row>
                </footer>
